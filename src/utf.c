...
get_encoding_function()
{
  ...
  switch (translate) {
    case utf8_to_utf16le:
      return (convertion_func_t)from_utf8_to_utf16le;
    case utf8_to_utf16be:
      return (convertion_func_t)from_utf8_to_utf16be;
    case utf16le_to_utf16be:
      return (convertion_func_t)from_utf16le_to_utf16be;
    case utf16be_to_utf16le:
      return (convertion_func_t)from_utf16be_to_utf16le;
    case utf16be_to_utf8:
      return (convertion_func_t)from_utf16be_to_utf8;
    case utf16le_to_utf8:
      return (convertion_func_t)from_utf16le_to_utf8;
    case transcribe_file:
      return (convertion_func_t)transcribe;
  }
  return NULL;
}
